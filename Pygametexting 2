# Newest Pygametexting with easy to add buttons, and removed the 100ms delay on the buttons, now you can control the delay depending on
# what you want to create, the delay was there to avoid unintentional double clicking
...
class pyg_text():
    ...
    def screen_button_centerpos(self,text, x_pos, y_pos, trans = None, size=None, color=None, 
        ...
        if trans == None:
            ...
            self.screen_text_centerpos(text,x_center,y_center)
    ...
    def screen_button_initpos(self,text, x_pos, y_pos, trans = None, size=None, color=None, 
        ...
        if trans == None:
            ...
            self.screen_text_initpos(text,x_init,y_init)
            if x_init<pygame.mouse.get_pos()[0]<x_limit and y_init<pygame.mouse.get_pos()[1]<y_limit:
    ...
    def screen_button_limitpos(self,text, x_pos, y_pos, trans = None, size=None, color=None, 
        ...
        if trans == None:
            ...
            self.screen_text_limitpos(text,x_limit,y_limit)
            if x_init<pygame.mouse.get_pos()[0]<x_limit and y_init<pygame.mouse.get_pos()[1]<y_limit:
